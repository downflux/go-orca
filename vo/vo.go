...
type VO interface {
	// ORCA is a set of hyperplanes in 2D ambient space of the form HP(p,
	// n), i.e.  the boundary of the plane passes through p, and faces
	// "into" the planar normal n. We consider points (i.e. velocities) in
	// the plane to be feasible values for the VO struct.
	//
